			...
			switch ($action)
			{
				...
				case 'add':
					...
					$forum_data += array(
						...
						'forum_op_only_view'		=> request_var('op_only_view', false),
		...
		switch ($action)
		{
			...
			case 'edit':
				...
				$template->assign_vars(array(
					...
					'OP_ONLY_VIEW'				=> $forum_data['forum_op_only_view'],
					...
					'S_OP_ONLY_VIEW_ENABLE'		=> ($forum_data['forum_op_only_view']) ? true : false,
