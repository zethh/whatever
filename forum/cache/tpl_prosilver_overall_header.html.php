<?php if (!defined('IN_PHPBB')) exit; if ($this->_rootref['WP_DTD']) {  echo (isset($this->_rootref['WP_DTD'])) ? $this->_rootref['WP_DTD'] : ''; } else { ?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><?php } ?><html xmlns="http://www.w3.org/1999/xhtml" dir="<?php echo (isset($this->_rootref['S_CONTENT_DIRECTION'])) ? $this->_rootref['S_CONTENT_DIRECTION'] : ''; ?>" lang="<?php echo (isset($this->_rootref['S_USER_LANG'])) ? $this->_rootref['S_USER_LANG'] : ''; ?>" xml:lang="<?php echo (isset($this->_rootref['S_USER_LANG'])) ? $this->_rootref['S_USER_LANG'] : ''; ?>">
<head>
...
<!--
	...
	Modified by:
-->
<?php if ($this->_rootref['WP_HEADERINFO_EARLY']) {  echo (isset($this->_rootref['WP_HEADERINFO_EARLY'])) ? $this->_rootref['WP_HEADERINFO_EARLY'] : ''; } ?>
...
<?php } if ($this->_rootref['WP_HEADERINFO_LATE']) {  echo (isset($this->_rootref['WP_HEADERINFO_LATE'])) ? $this->_rootref['WP_HEADERINFO_LATE'] : ''; } ?>
...
<?php if ($this->_rootref['S_BLOG']) {  ?><li class="icon-members"><a href="<?php echo (isset($this->_rootref['U_BLOG'])) ? $this->_rootref['U_BLOG'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_BLOG'])) ? $this->_rootref['L_BLOG'] : ((isset($user->lang['BLOG'])) ? $user->lang['BLOG'] : '{ BLOG }')); ?>"><?php echo ((isset($this->_rootref['L_BLOG'])) ? $this->_rootref['L_BLOG'] : ((isset($user->lang['BLOG'])) ? $user->lang['BLOG'] : '{ BLOG }')); ?></a></li><?php } if (! $this->_rootref['S_IS_BOT']) {  if ($this->_rootref['S_DISPLAY_MEMBERLIST']) {  ?><li class="icon-members"><a href="<?php echo (isset($this->_rootref['U_MEMBERLIST'])) ? $this->_rootref['U_MEMBERLIST'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_MEMBERLIST_EXPLAIN'])) ? $this->_rootref['L_MEMBERLIST_EXPLAIN'] : ((isset($user->lang['MEMBERLIST_EXPLAIN'])) ? $user->lang['MEMBERLIST_EXPLAIN'] : '{ MEMBERLIST_EXPLAIN }')); ?>"><?php echo ((isset($this->_rootref['L_MEMBERLIST'])) ? $this->_rootref['L_MEMBERLIST'] : ((isset($user->lang['MEMBERLIST'])) ? $user->lang['MEMBERLIST'] : '{ MEMBERLIST }')); ?></a></li><?php } if (! $this->_rootref['S_USER_LOGGED_IN'] && $this->_rootref['S_REGISTER_ENABLED'] && ! ( $this->_rootref['S_SHOW_COPPA'] || $this->_rootref['S_REGISTRATION'] )) {  ?><li class="icon-register"><a href="<?php echo (isset($this->_rootref['U_REGISTER'])) ? $this->_rootref['U_REGISTER'] : ''; ?>"><?php echo ((isset($this->_rootref['L_REGISTER'])) ? $this->_rootref['L_REGISTER'] : ((isset($user->lang['REGISTER'])) ? $user->lang['REGISTER'] : '{ REGISTER }')); ?></a></li><?php } ?>
